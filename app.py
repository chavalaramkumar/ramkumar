...
def chat_with_bot():
    ...
    # elif user_message == 'who is the ceo of t hub':
    #     return jsonify({"response": "Babji Neelam"})
    # elif user_message == 'who is the trainer of aws devops ':
    #     return jsonify({"response": " Pavan Teja R,Aravind P "})
    # elif user_message == 'where is aws devops class room':
    #     return jsonify({"response": " hall 2.2"})
    # elif user_message == 'who is the trasiner of servicenow':
    #     return jsonify({"response": "Raja choudhary P D"})
    # elif user_message == 'where is the servicenow class room':
    #     return jsonify({"response": "hall 2.1"})
    # elif user_message == 'where is the ceo cabin':
    #     return jsonify({"response": "3rd floor"})
    # elif user_message == 'where is the aws devolopment class room':
    #     return jsonify({"response": "4th Floor Hall 4.2"})
    # elif user_message == 'where is the google flutter':
    #     return jsonify({"response": "3rd Floor Bay 3.1"})
    # elif user_message == 'where is the vlsi class room':
    #     return jsonify({"response": "3rd Floor Bay 3.2"})
    # elif user_message == 'where is the data analytics class room':
    #     return jsonify({"response": "3rd Floor Bay 3.3"})
    # elif user_message == 'where is the cloud3 class room':
    #     return jsonify({"response": "3rd Floor Bay 3.4"})
    # elif user_message == 'where is the salesforce class room':
    #     return jsonify({"response": "3rd Floor Bay 3.5"})
    # elif user_message == 'where is the fsd class room':
    #     return jsonify({"response": "4th Floor Hall 4.1"})
    # elif user_message == 'where is the gen ai class room':
    #     return jsonify({"response": "5th Floor ISLAND-1"})
    # elif user_message == 'where is the cybersecurity class room':
    #     return jsonify({"response": "5th Floor ISLAND-2"})
    # elif user_message == 'where is the orecel apex class room':
    #     return jsonify({"response": "5th Floor ISLAND-3"})
    # elif user_message == 'where is the uiux class room':
    #     return jsonify({"response": "5th Floor ISLAND-4"})
    # elif user_message == 'where is the pega class room':
    #     return jsonify({"response": "5th Floor ISLAND-5and Hall 5.2"})
    # elif user_message == 'where is the owl coder class room':
    #     return jsonify({"response": "5th Floor Hall 5.3"})
    # elif user_message == 'who is the trainer for aws development':
    #     return jsonify({"response": "shifu zama sir"})
    # elif user_message == 'who is the trainer for flutter':
    #     return jsonify({"response": "Kirshna and Vasanth sir"})
    # elif user_message == 'who is the trainer for vlsi':
    #     return jsonify({"response": "Ashok sir"})
    # elif user_message == 'who is the trainer for data analytics':
    #     return jsonify({"reponse": "Harsha Vardhini Madam"})
    # elif user_message == 'who is the trainer for cloud3':
    #     return jsonify({"response": "Arvind and Keshor sir"})
    # elif user_message == 'who is the trainer for saleforce':
    #     return jsonify({"response": "Marni Srinu Sir"})
    # elif user_message == 'who is the trainer for fsd':
    #     return jsonify({"response": "Durga Sai Prasad and Hanuman Sir"})
    # elif user_message == 'who is the trainer for gen ai':
    #     return jsonify({"response": "Aravind Sir"})
    # elif user_message == 'who is the trainer for cybersecurity':
    #     return jsonify({"response": " Sai Kala Madam and J Peter Sir "})
    # elif user_message == 'who is the trainer of pega':
    #     return jsonify({"response": "Raja Choudhary and Muthyala Babu Sir"})
    # elif user_message == 'bye':
    #     return jsonify({"response": "ok bye, have a good day"})
    # else :
